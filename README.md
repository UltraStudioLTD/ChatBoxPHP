...
## Planned Features
  ...
  - [x] Adding Media (Images, GIF, Videos) Messages [Finished but Basic Design]
  - [x] Adding File(s) Upload (Media Upload extension) [Finished but Basic Design]
  - [x] Adding Preview Code for Code files [Few supported and no syntax]
